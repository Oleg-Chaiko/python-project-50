def creat_diff(dict_1, dict_2):
    ...
    for key in keys:
        ...
        if key not in dict_2:
            dictionary[key] = {
                'status': 'deleted',
                'value': creat_diff(dict_1[key], dict_1[key])
            ...
            dictionary[key] = {
                'status': 'added',
                'value': creat_diff(dict_2[key], dict_2[key])
            ...
            dictionary[key] = {
                'status': 'unchanged',
                'value': creat_diff(dict_1[key], dict_2[key])
                if isinstance(dict_1[key], dict)
                else dict_1[key]
            }
        elif dict_1[key] != dict_2[key]:
...
def changed_val(dict_1, dict_2, key):
    ...
    if stat_value_1 and stat_value_2:
        ...
        dict_[key] = {
            'status': 'changed',
            'initial_value': creat_diff(dict_1[key], dict_1[key]),
        ...
        dict_[key] = {
            ...
            'current_value': creat_diff(dict_2[key], dict_2[key])
        }
    else:
        dict_[key] = {
            'status': 'changed',
